/*
	...
	比如说：
		...
		10.0/3 如果采用double来存储的话结果可能是：3.333333333
	...
	为什么？
		因为现实世界中有这种无限循环的数据，例如：3.33333333333....
		数据实际上是无限循环，当时计算机的内存有限，用一个有限的资源
		表示无限的数据，只能存储近似值。
...
public class floatTest01
{
	public static void main(String[] args){
		...
		//原理:先将5转换成double类型，然后在做运算，结果是double
		//大容量无法直接赋值给小容量，需要强转
		//int i = 10.0/5;
