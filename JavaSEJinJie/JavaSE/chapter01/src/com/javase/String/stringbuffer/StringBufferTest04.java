...
2、StringBuilder/StringBuffer为什么是可变的呢？
    ...
    这个byte[]数组没有被final修饰，StringBuffer/String的初始化容量我记得
    应该是16，当存满之后会进行扩容，底层调用了数组拷贝的方法System.arraycopy()...
...
public class StringBufferTest04 {
    public static void main(String[] args) {
        ...
        //s变量是可以指向其它对象的。
        //字符串不可变不是说以上变量s不可变。说的事"abc"这个对象不可变。
        s = "xyz"; //"xyz"放到了字符串常量池当中的。"xyz"不可变。
