...
/*
1、向Map集合中存，以及从Map集合中去，都是先调用key的hashCode方法，然后在调用equals方法！
...
public class HashMapTest02 {
    public static void main(String[] args) {
        ...
        //System.out.println(s1.equals(s2));// false,没有重写equals方法之前是false
        ...
        studentSet.add(s1);
        studentSet.add(s2);
        System.out.println(studentSet.size());//这个结果按说应该是1，但是结果是2，显然不符合HashSet集合存储特点。
